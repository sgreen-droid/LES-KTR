...
- [OpenStreetMap geocoding](osm-geocoding-policy.md) — recovery maps are Google-free; public Nominatim is explicit opt-in and must not receive production coordinates by default.
